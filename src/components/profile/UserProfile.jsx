        ...
        const loadUserData = async () => {
            if (user && user.userId) {
                try {
                    ...
                    const dynamoDbData = await getUserFromDynamoDB(user.userId);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (user && user.userId) {
                ...
                await updateUserInDynamoDB(user.userId, {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6">
                    ...
                    <textarea
                        id="bio"
                        rows="4"
                        className="block w-full px-4 py-3 border border-gray-200 rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-300"
